...
def a(client, message):
    ...
    try:
        ...
        rep = f"✅ **Yüklədi** [Ledy Bot](https://t.me/{Config.BOT_USERNAME})"
        ...
        m.delete()
        bot.send_audio(chat_id=Config.PLAYLIST_ID, audio=audio_file, caption=rep, performer="SOQrup", parse_mode='md', title=title, duration=dur, thumb=thumb_name)
    except Exception as e:
